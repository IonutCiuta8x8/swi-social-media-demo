...
public class Data {
    ...
    public static class Posts {
        public static final Post elonPostAboutMars = new Post(Users.elon, "Can't wait to be the president of Mars.", List.of(), 1499, Posted._1minAgo, false, false);
        public static final Post elonPostAbouSocialMedia = new Post(Users.elon, "I will fix $1.", List.of(Hashtags.socialMedia), 120, Posted._8hAgo, false, false);
        public static final Post elonPostAbouApi = new Post(Users.elon, "$1 will start charging devs more for API usage.", List.of(Hashtags.twitter), 387, Posted._1dayAgo, false, false);
    ...
    public static class Reposts {
        public static final Repost lexMarsRepost = new Repost(Users.lex, "Yes, let's make it happen!", List.of(), 500, Posted.now.get(), Posts.elonPostAboutMars, false, false);
        public static final Repost lexSocialMediaRepost = new Repost(Users.lex, "What can be we do to make it better though? $1", List.of(Hashtags.socialMedia), 1001, Posted.now.get(), Posts.zuckPostAboutSocialMedia, false, false);
    }
}
